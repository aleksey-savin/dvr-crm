...
import {
  ...
  accountRisks,
  companyContact,
  accountTargetForecasts,
  accountUpsellingOpportunities,
  companyRevenue,
  accountGrossProfits,
...
export const accountTargetForecastsRelations = relations(
  accountTargetForecasts,
  ({ one }) => ({
    companyAccount: one(companyAccount, {
...
export const accountUpsellingOpportunitiesRelations = relations(
  accountUpsellingOpportunities,
  ({ one }) => ({
    companyAccount: one(companyAccount, {
...
export const accountGrossProfitsRelations = relations(
  accountGrossProfits,
  ({ one }) => ({
    companyAccount: one(companyAccount, {
