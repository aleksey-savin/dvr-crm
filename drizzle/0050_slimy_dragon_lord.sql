...
ALTER TABLE "lead" ADD COLUMN "source_id" text;--> statement-breakpoint
ALTER TABLE "lead" ADD COLUMN "lost_reason_id" text;--> statement-breakpoint
...
ALTER TABLE "signal" ADD COLUMN "signal_type_id" text;--> statement-breakpoint
...
ALTER TABLE "tender" ADD COLUMN "lost_reason_id" text;--> statement-breakpoint
...
CREATE INDEX "tender_lost_reason_id_idx" ON "tender" USING btree ("lost_reason_id");--> statement-breakpoint
ALTER TABLE "lead" DROP COLUMN "source";--> statement-breakpoint
ALTER TABLE "lead" DROP COLUMN "lost_reason";--> statement-breakpoint
ALTER TABLE "signal" DROP COLUMN "signal_type";--> statement-breakpoint
ALTER TABLE "tender" DROP COLUMN "lost_reason";