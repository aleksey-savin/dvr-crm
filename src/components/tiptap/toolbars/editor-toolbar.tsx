...
const EditorToolbarInner = ({ editor }: { editor: Editor }) => {
  return (
...
// Skip re-renders caused by parent form state updates — the editor instance
// is stable (same object reference) across keystrokes in Tiptap v3.
export const EditorToolbar = memo(EditorToolbarInner, (prev, next) => {
