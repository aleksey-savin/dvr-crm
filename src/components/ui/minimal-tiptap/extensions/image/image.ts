...
declare module '@tiptap/react' {
  interface Commands<TReturnType> {
    ...
    downloadImage: {
      downloadImage: (attrs: DownloadImageCommandProps) => TReturnType
    }
    copyImage: {
      copyImage: (attrs: DownloadImageCommandProps) => TReturnType
    }
    copyLink: {
      copyLink: (attrs: DownloadImageCommandProps) => TReturnType
    }
    toggleImage: {
      toggleImage: () => TReturnType
    }
  }
}
