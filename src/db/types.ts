...
export type UpdateDepartment = Partial<Omit<InsertDepartment, 'id' | 'createdAt' | 'updatedAt'>>

// ─── Company ─────────────────────────────────────────────────────────────────

export type SelectCompany = InferSelectModel<typeof company>
export type InsertCompany = InferInsertModel<typeof company>
export type UpdateCompany = Partial<Omit<InsertCompany, 'id' | 'createdAt' | 'updatedAt'>>
...
export type UpdateCompanyAccount = Partial<Omit<InsertCompanyAccount, 'id' | 'createdAt' | 'updatedAt'>>
...
export type UpdateAccountRisk = Partial<Omit<InsertAccountRisk, 'id' | 'createdAt' | 'updatedAt'>>

export type SelectAccountGrossProfit = InferSelectModel<typeof accountGrossProfit>
export type InsertAccountGrossProfit = InferInsertModel<typeof accountGrossProfit>
export type UpdateAccountGrossProfit = Partial<Omit<InsertAccountGrossProfit, 'id' | 'createdAt' | 'updatedAt'>>

export type SelectAccountTargetForecast = InferSelectModel<typeof accountTargetForecast>
export type InsertAccountTargetForecast = InferInsertModel<typeof accountTargetForecast>
export type UpdateAccountTargetForecast = Partial<Omit<InsertAccountTargetForecast, 'id' | 'createdAt' | 'updatedAt'>>

export type SelectAccountUpsellingOpportunity = InferSelectModel<typeof accountUpsellingOpportunity>
export type InsertAccountUpsellingOpportunity = InferInsertModel<typeof accountUpsellingOpportunity>
export type UpdateAccountUpsellingOpportunity = Partial<Omit<InsertAccountUpsellingOpportunity, 'id' | 'createdAt' | 'updatedAt'>>
...
export type UpdateAccountHook = Partial<Omit<InsertAccountHook, 'id' | 'createdAt' | 'updatedAt'>>
...
export type UpdateCompanyRevenue = Partial<Omit<InsertCompanyRevenue, 'id' | 'createdAt' | 'updatedAt'>>
...
export type UpdateCompanyContact = Partial<Omit<InsertCompanyContact, 'id' | 'createdAt' | 'updatedAt'>>

// ─── Todo ────────────────────────────────────────────────────────────────────

export type SelectTodo = InferSelectModel<typeof todo>
export type InsertTodo = InferInsertModel<typeof todo>
export type UpdateTodo = Partial<Omit<InsertTodo, 'id' | 'createdAt' | 'updatedAt'>>

export type SelectTodoResponsibleUsers = InferSelectModel<typeof todoResponsibleUsers>
export type InsertTodoResponsibleUsers = InferInsertModel<typeof todoResponsibleUsers>

// ─── Comments ────────────────────────────────────────────────────────────────

export type SelectComment = InferSelectModel<typeof comment>
export type InsertComment = InferInsertModel<typeof comment>
export type UpdateComment = Partial<Omit<InsertComment, 'id' | 'createdAt' | 'updatedAt'>>
...
export type UpdateApiKey = Partial<Omit<InsertApiKey, 'id' | 'createdAt' | 'updatedAt'>>
